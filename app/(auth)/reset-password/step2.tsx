...
/**
 * Password reset step UI that lets the user set and confirm a new password.
 *
 * Renders inputs for a new password and its confirmation, validates that the
 * password contains at least one letter, one digit, one special character, and
 * is at least 8 characters long, and ensures the confirmation matches. On
 * successful submission the current routes are dismissed and navigation replaces
 * the stack with the reset-password success screen.
 *
 * @returns A React element for the reset-password step screen
 */
