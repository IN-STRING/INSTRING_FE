...
/**
 * Renders the survey screen for selecting which instrument the user manages.
 *
 * Shows four instrument option cards, updates the survey store when an option is selected, and provides a submit button that navigates to the next survey step.
 *
 * @returns The instrument selection screen as a React element.
 */
