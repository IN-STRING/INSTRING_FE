...
/**
 * Renders the login screen that collects email and password and handles submission.
 *
 * The form validates that both fields are present; submitting the form stores an auth token and navigates to the app root.
 *
 * @returns The JSX element for the login screen.
 */
